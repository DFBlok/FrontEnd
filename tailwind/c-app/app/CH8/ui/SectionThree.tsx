        ...
        <div className="w-[80%] mx-auto flex flex-col lg:flex-row gap-6">
          <div className="p-2">
            ...
            <p className="text-lg mb-4">
              ...
              sapiente accusantium accusamus. Repellendus facilis nihil illum,
              vel unde harum sint? Quidem, magnam! Voluptates harum voluptate,
              voluptatum vero quaerat recusandae.
            </p>
          </div>
          <div className="flex flex-col gap-6 md:flex-row lg:flex-col">
            <div className="bg-gray-800 text-white p-6 text-center">
              <h1 className="font-oswald text-4xl mb-4">Break it down</h1>
              <p className="font-moon text-lg">
                Lorem ipsum dolor sit, amet consectetur adipisicing elit. Nam
                earum nemo, nostrum cumque repellat iure mollitia libero
                corporis voluptate voluptas hic eius autem repellendus harum.
                Ipsa aspernatur id quae ab.
              </p>
            </div>
            <div className="bg-gray-800 text-white p-6 text-center">
              ...
              <p className="text-lg">
                ...
                repudiandae provident libero nesciunt similique molestias
                possimus adipisci eum error soluta tenetur numquam ab corrupti.
              </p>
            </div>
            <div className="bg-gray-800 text-white p-6 text-center">
              <p className="text-lg">
