        ...
        <div className='w-[80%] mx-auto p-5'>
          <div className='flex gap-10'>
              <div className='text-center p-5'>
                <h1 className='text-purple-500 font-bold text-2xl mb-4'>Cheap</h1>
                <p className='justify-center'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Eius hic dignissimos error nemo? Soluta error autem sapiente dignissimos in earum eos, ratione voluptatum quia? Excepturi aut minima aperiam vero quidem.</p>
              </div>
              <div className='text-center p-5'>
                <h1 className='text-purple-500 font-bold text-2xl mb-4'>Quick</h1>
              ...
              <div className='text-center p-5'>
                <h1 className='text-purple-500 font-bold text-2xl mb-4'>Quality</h1>
                <p className='text-center'>
